...
import ProjectMapSection from "@/components/common/ProjectMapSection";
...
export default function ContactClient() {
  ...
  // ✅ UPDATED: Actually sends email via /api/contact
  async function handleSubmit(e) {
    ...
    try {
      ...
      setStatus({
        type: "success",
        msg: "Thanks! We received your message. We'll reply soon.",
      });
