...
export default function Footer() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const statutoryItems = footerRef.current?.querySelectorAll(`.${styles.statutoryItem}`);
      ...
      gsap.set(statutoryItems, { opacity: 0, x: -14 });
      ...
      // Statutory items (left in)
      tl.to(statutoryItems, { opacity: 1, x: 0, duration: 0.26, stagger: 0.06 }, "-=0.22");
    ...
    <footer ref={footerRef} className={styles.footer}>
      ...
      <div className={`container ${styles.content}`}>
        <div className="row gy-4 align-items-start">
          ...
          <div className="col-12 col-lg-3">
            <div className={styles.statutoryBox}>
              <h6 className={styles.colTitle}>Statutory Details</h6>

              <div className={styles.statutoryList}>
                <div className={styles.statutoryItem}>
                  <span className={styles.statutoryLabel}>CIN:</span>
                  <span className={styles.statutoryValue}>U68200BR2025PTC080629</span>
                </div>

                <div className={styles.statutoryItem}>
                  <span className={styles.statutoryLabel}>PAN:</span>
                  <span className={styles.statutoryValue}>ABECA3302K</span>
                </div>

                <div className={styles.statutoryItem}>
                  <span className={styles.statutoryLabel}>TAN:</span>
                  <span className={styles.statutoryValue}>PTNA13661E</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 col-lg-3">
            ...
            <div className={styles.contactList}>
              <div className={styles.contactItem}>
                <Image src="/images/icons/footer-icons/phone.png" alt="Phone" width={22} height={20} />
                <a href="tel:+918521962739">+91 8521962739</a>
              </div>

              <div className={styles.contactItem}>
                <Image src="/images/icons/footer-icons/mail.png" alt="Email" width={22} height={20} />
                <a href="mailto:anantabhivrdhhipvtltd@gmail.com">anantabhivrdhhipvtltd@gmail.com</a>
              </div>

              <div className={styles.contactItem}>
                <Image src="/images/icons/footer-icons/location.png" alt="Location" width={25} height={20} />
        ...
        <div className={styles.bottomRow}>
          <span>
            © Dec 2026 All Rights Reserved, Powered by{" "}
            <a
              href="https://ardentpixels.studio/"
              target="_blank"
            ...
            |
            <a
              href="https://www.linkedin.com/in/geetansh-srivastava-89b545368"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.highlightedName}
            >
