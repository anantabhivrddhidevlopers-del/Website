      ...
      <div className={`container ${styles.content}`}>
        ...
        <div className={styles.bottomRow}>
          <span>
            ...
            <a href="https://ardentpixels.studio/" target="_blank" rel="noopener noreferrer">
              AP
            </a>
            |
            <a href="https://www.linkedin.com/in/geetansh-srivastava-89b545368" target="_blank" rel="noopener noreferrer">
              Geetansh
            </a>
          </span>
