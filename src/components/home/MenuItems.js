      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="mainNavbar">
          <ul className={`navbar-nav mx-auto mb-2 mb-lg-0 ${styles.navLinks}`}>
            ...
            {/* ✅ Dropdown opens on hover (desktop via CSS) */}
            <li className={`nav-item dropdown ${styles.dropdownHover}`}>
              ...
              <ul className={`dropdown-menu dropdown-menu-dark ${styles.dropdownMenu}`}>
                <li>
                  <Link className={`dropdown-item ${styles.dropdownItem}`} href="/projects">
                    buildings
                  </Link>
                </li>
                <li>
                  <Link className={`dropdown-item ${styles.dropdownItem}`} href="/projects/ongoing">
                    Agriculture
                  </Link>
                </li>
                <li>
                  <Link className={`dropdown-item ${styles.dropdownItem}`} href="/projects/completed">
                    Plots
                  </Link>
                </li>
              </ul>
